...
class ApiFWH:
    """
    ApiFWH class for handling api operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ApiFWH initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ApiFWH: {e}")
            return False
...
def create_api_instance(config: Optional[Dict] = None) -> ApiFWH:
    """Factory function to create api instance"""
    instance = ApiFWH(config)
    instance.initialize()
    return instance
