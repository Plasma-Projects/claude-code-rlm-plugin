...
class ApiDXQ:
    """
    ApiDXQ class for handling api operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ApiDXQ initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ApiDXQ: {e}")
            return False
...
def create_api_instance(config: Optional[Dict] = None) -> ApiDXQ:
    """Factory function to create api instance"""
    instance = ApiDXQ(config)
    instance.initialize()
    return instance
