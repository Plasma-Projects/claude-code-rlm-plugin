...
class ApiJQP:
    """
    ApiJQP class for handling api operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ApiJQP initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ApiJQP: {e}")
            return False
...
def create_api_instance(config: Optional[Dict] = None) -> ApiJQP:
    """Factory function to create api instance"""
    instance = ApiJQP(config)
    instance.initialize()
    return instance
