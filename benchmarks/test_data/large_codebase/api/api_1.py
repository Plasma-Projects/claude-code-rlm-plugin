...
class ApiVAQ:
    """
    ApiVAQ class for handling api operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ApiVAQ initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ApiVAQ: {e}")
            return False
...
def create_api_instance(config: Optional[Dict] = None) -> ApiVAQ:
    """Factory function to create api instance"""
    instance = ApiVAQ(config)
    instance.initialize()
    return instance
