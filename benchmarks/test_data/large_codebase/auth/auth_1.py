...
class AuthXEO:
    """
    AuthXEO class for handling auth operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"AuthXEO initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize AuthXEO: {e}")
            return False
...
def create_auth_instance(config: Optional[Dict] = None) -> AuthXEO:
    """Factory function to create auth instance"""
    instance = AuthXEO(config)
    instance.initialize()
    return instance
