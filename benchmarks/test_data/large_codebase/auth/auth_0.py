...
class AuthYVM:
    """
    AuthYVM class for handling auth operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"AuthYVM initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize AuthYVM: {e}")
            return False
...
def create_auth_instance(config: Optional[Dict] = None) -> AuthYVM:
    """Factory function to create auth instance"""
    instance = AuthYVM(config)
    instance.initialize()
    return instance
