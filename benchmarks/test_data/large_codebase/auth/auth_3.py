...
class AuthNRF:
    """
    AuthNRF class for handling auth operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"AuthNRF initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize AuthNRF: {e}")
            return False
...
def create_auth_instance(config: Optional[Dict] = None) -> AuthNRF:
    """Factory function to create auth instance"""
    instance = AuthNRF(config)
    instance.initialize()
    return instance
