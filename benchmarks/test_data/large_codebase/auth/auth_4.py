...
class AuthNMJ:
    """
    AuthNMJ class for handling auth operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"AuthNMJ initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize AuthNMJ: {e}")
            return False
...
def create_auth_instance(config: Optional[Dict] = None) -> AuthNMJ:
    """Factory function to create auth instance"""
    instance = AuthNMJ(config)
    instance.initialize()
    return instance
