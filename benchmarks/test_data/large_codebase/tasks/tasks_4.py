...
class TasksYAE:
    """
    TasksYAE class for handling tasks operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"TasksYAE initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize TasksYAE: {e}")
            return False
...
def create_tasks_instance(config: Optional[Dict] = None) -> TasksYAE:
    """Factory function to create tasks instance"""
    instance = TasksYAE(config)
    instance.initialize()
    return instance
