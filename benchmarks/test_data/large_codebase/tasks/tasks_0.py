...
class TasksYMU:
    """
    TasksYMU class for handling tasks operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"TasksYMU initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize TasksYMU: {e}")
            return False
...
def create_tasks_instance(config: Optional[Dict] = None) -> TasksYMU:
    """Factory function to create tasks instance"""
    instance = TasksYMU(config)
    instance.initialize()
    return instance
