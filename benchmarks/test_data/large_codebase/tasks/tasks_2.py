...
class TasksKCJ:
    """
    TasksKCJ class for handling tasks operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"TasksKCJ initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize TasksKCJ: {e}")
            return False
...
def create_tasks_instance(config: Optional[Dict] = None) -> TasksKCJ:
    """Factory function to create tasks instance"""
    instance = TasksKCJ(config)
    instance.initialize()
    return instance
