...
class TasksKCP:
    """
    TasksKCP class for handling tasks operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"TasksKCP initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize TasksKCP: {e}")
            return False
...
def create_tasks_instance(config: Optional[Dict] = None) -> TasksKCP:
    """Factory function to create tasks instance"""
    instance = TasksKCP(config)
    instance.initialize()
    return instance
