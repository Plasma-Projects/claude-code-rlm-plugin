...
class ControllersDVB:
    """
    ControllersDVB class for handling controllers operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ControllersDVB initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ControllersDVB: {e}")
            return False
...
def create_controllers_instance(config: Optional[Dict] = None) -> ControllersDVB:
    """Factory function to create controllers instance"""
    instance = ControllersDVB(config)
    instance.initialize()
    return instance
