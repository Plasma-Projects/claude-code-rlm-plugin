...
class ControllersQUZ:
    """
    ControllersQUZ class for handling controllers operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ControllersQUZ initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ControllersQUZ: {e}")
            return False
...
def create_controllers_instance(config: Optional[Dict] = None) -> ControllersQUZ:
    """Factory function to create controllers instance"""
    instance = ControllersQUZ(config)
    instance.initialize()
    return instance
