...
class ControllersHOU:
    """
    ControllersHOU class for handling controllers operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ControllersHOU initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ControllersHOU: {e}")
            return False
...
def create_controllers_instance(config: Optional[Dict] = None) -> ControllersHOU:
    """Factory function to create controllers instance"""
    instance = ControllersHOU(config)
    instance.initialize()
    return instance
