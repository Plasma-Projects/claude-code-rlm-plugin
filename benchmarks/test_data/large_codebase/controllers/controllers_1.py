...
class ControllersPFC:
    """
    ControllersPFC class for handling controllers operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ControllersPFC initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ControllersPFC: {e}")
            return False
...
def create_controllers_instance(config: Optional[Dict] = None) -> ControllersPFC:
    """Factory function to create controllers instance"""
    instance = ControllersPFC(config)
    instance.initialize()
    return instance
