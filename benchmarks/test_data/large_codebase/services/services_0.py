...
class ServicesJYA:
    """
    ServicesJYA class for handling services operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ServicesJYA initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ServicesJYA: {e}")
            return False
...
def create_services_instance(config: Optional[Dict] = None) -> ServicesJYA:
    """Factory function to create services instance"""
    instance = ServicesJYA(config)
    instance.initialize()
    return instance
