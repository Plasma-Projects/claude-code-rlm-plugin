...
class ServicesNKR:
    """
    ServicesNKR class for handling services operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ServicesNKR initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ServicesNKR: {e}")
            return False
...
def create_services_instance(config: Optional[Dict] = None) -> ServicesNKR:
    """Factory function to create services instance"""
    instance = ServicesNKR(config)
    instance.initialize()
    return instance
