...
class ServicesRPY:
    """
    ServicesRPY class for handling services operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ServicesRPY initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ServicesRPY: {e}")
            return False
...
def create_services_instance(config: Optional[Dict] = None) -> ServicesRPY:
    """Factory function to create services instance"""
    instance = ServicesRPY(config)
    instance.initialize()
    return instance
