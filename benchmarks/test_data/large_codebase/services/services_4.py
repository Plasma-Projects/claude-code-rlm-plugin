...
class ServicesNNX:
    """
    ServicesNNX class for handling services operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ServicesNNX initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ServicesNNX: {e}")
            return False
...
def create_services_instance(config: Optional[Dict] = None) -> ServicesNNX:
    """Factory function to create services instance"""
    instance = ServicesNNX(config)
    instance.initialize()
    return instance
