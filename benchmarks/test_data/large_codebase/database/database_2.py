...
class DatabaseFHP:
    """
    DatabaseFHP class for handling database operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"DatabaseFHP initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize DatabaseFHP: {e}")
            return False
...
def create_database_instance(config: Optional[Dict] = None) -> DatabaseFHP:
    """Factory function to create database instance"""
    instance = DatabaseFHP(config)
    instance.initialize()
    return instance
