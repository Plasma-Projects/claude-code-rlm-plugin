...
class DatabaseWAF:
    """
    DatabaseWAF class for handling database operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"DatabaseWAF initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize DatabaseWAF: {e}")
            return False
...
def create_database_instance(config: Optional[Dict] = None) -> DatabaseWAF:
    """Factory function to create database instance"""
    instance = DatabaseWAF(config)
    instance.initialize()
    return instance
