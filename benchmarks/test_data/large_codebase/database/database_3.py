...
class DatabaseLZZ:
    """
    DatabaseLZZ class for handling database operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"DatabaseLZZ initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize DatabaseLZZ: {e}")
            return False
...
def create_database_instance(config: Optional[Dict] = None) -> DatabaseLZZ:
    """Factory function to create database instance"""
    instance = DatabaseLZZ(config)
    instance.initialize()
    return instance
