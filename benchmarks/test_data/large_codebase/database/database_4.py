...
class DatabaseYOH:
    """
    DatabaseYOH class for handling database operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"DatabaseYOH initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize DatabaseYOH: {e}")
            return False
...
def create_database_instance(config: Optional[Dict] = None) -> DatabaseYOH:
    """Factory function to create database instance"""
    instance = DatabaseYOH(config)
    instance.initialize()
    return instance
