...
class ViewsAJL:
    """
    ViewsAJL class for handling views operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ViewsAJL initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ViewsAJL: {e}")
            return False
...
def create_views_instance(config: Optional[Dict] = None) -> ViewsAJL:
    """Factory function to create views instance"""
    instance = ViewsAJL(config)
    instance.initialize()
    return instance
