...
class ViewsDMH:
    """
    ViewsDMH class for handling views operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ViewsDMH initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ViewsDMH: {e}")
            return False
...
def create_views_instance(config: Optional[Dict] = None) -> ViewsDMH:
    """Factory function to create views instance"""
    instance = ViewsDMH(config)
    instance.initialize()
    return instance
