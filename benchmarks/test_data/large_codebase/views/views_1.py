...
class ViewsHAP:
    """
    ViewsHAP class for handling views operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ViewsHAP initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ViewsHAP: {e}")
            return False
...
def create_views_instance(config: Optional[Dict] = None) -> ViewsHAP:
    """Factory function to create views instance"""
    instance = ViewsHAP(config)
    instance.initialize()
    return instance
