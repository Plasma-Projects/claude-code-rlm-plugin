...
class UtilsXEK:
    """
    UtilsXEK class for handling utils operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"UtilsXEK initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize UtilsXEK: {e}")
            return False
...
def create_utils_instance(config: Optional[Dict] = None) -> UtilsXEK:
    """Factory function to create utils instance"""
    instance = UtilsXEK(config)
    instance.initialize()
    return instance
