...
class UtilsYIV:
    """
    UtilsYIV class for handling utils operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"UtilsYIV initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize UtilsYIV: {e}")
            return False
...
def create_utils_instance(config: Optional[Dict] = None) -> UtilsYIV:
    """Factory function to create utils instance"""
    instance = UtilsYIV(config)
    instance.initialize()
    return instance
