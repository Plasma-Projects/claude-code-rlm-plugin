...
class UtilsJAN:
    """
    UtilsJAN class for handling utils operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"UtilsJAN initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize UtilsJAN: {e}")
            return False
...
def create_utils_instance(config: Optional[Dict] = None) -> UtilsJAN:
    """Factory function to create utils instance"""
    instance = UtilsJAN(config)
    instance.initialize()
    return instance
