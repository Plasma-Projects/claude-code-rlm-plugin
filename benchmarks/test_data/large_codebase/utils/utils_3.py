...
class UtilsFXD:
    """
    UtilsFXD class for handling utils operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"UtilsFXD initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize UtilsFXD: {e}")
            return False
...
def create_utils_instance(config: Optional[Dict] = None) -> UtilsFXD:
    """Factory function to create utils instance"""
    instance = UtilsFXD(config)
    instance.initialize()
    return instance
