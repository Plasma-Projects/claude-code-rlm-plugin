...
class ConfigEAW:
    """
    ConfigEAW class for handling config operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ConfigEAW initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ConfigEAW: {e}")
            return False
...
def create_config_instance(config: Optional[Dict] = None) -> ConfigEAW:
    """Factory function to create config instance"""
    instance = ConfigEAW(config)
    instance.initialize()
    return instance
