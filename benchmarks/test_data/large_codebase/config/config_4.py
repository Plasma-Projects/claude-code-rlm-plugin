...
class ConfigSXS:
    """
    ConfigSXS class for handling config operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ConfigSXS initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ConfigSXS: {e}")
            return False
...
def create_config_instance(config: Optional[Dict] = None) -> ConfigSXS:
    """Factory function to create config instance"""
    instance = ConfigSXS(config)
    instance.initialize()
    return instance
