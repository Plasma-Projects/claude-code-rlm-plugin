...
class ConfigAAR:
    """
    ConfigAAR class for handling config operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ConfigAAR initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ConfigAAR: {e}")
            return False
...
def create_config_instance(config: Optional[Dict] = None) -> ConfigAAR:
    """Factory function to create config instance"""
    instance = ConfigAAR(config)
    instance.initialize()
    return instance
