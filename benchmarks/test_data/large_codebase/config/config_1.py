...
class ConfigCTV:
    """
    ConfigCTV class for handling config operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ConfigCTV initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ConfigCTV: {e}")
            return False
...
def create_config_instance(config: Optional[Dict] = None) -> ConfigCTV:
    """Factory function to create config instance"""
    instance = ConfigCTV(config)
    instance.initialize()
    return instance
