...
class ModelsYNX:
    """
    ModelsYNX class for handling models operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ModelsYNX initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ModelsYNX: {e}")
            return False
...
def create_models_instance(config: Optional[Dict] = None) -> ModelsYNX:
    """Factory function to create models instance"""
    instance = ModelsYNX(config)
    instance.initialize()
    return instance
