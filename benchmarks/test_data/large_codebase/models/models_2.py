...
class ModelsLRU:
    """
    ModelsLRU class for handling models operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ModelsLRU initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ModelsLRU: {e}")
            return False
...
def create_models_instance(config: Optional[Dict] = None) -> ModelsLRU:
    """Factory function to create models instance"""
    instance = ModelsLRU(config)
    instance.initialize()
    return instance
