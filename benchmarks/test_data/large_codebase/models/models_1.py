...
class ModelsHYD:
    """
    ModelsHYD class for handling models operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ModelsHYD initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ModelsHYD: {e}")
            return False
...
def create_models_instance(config: Optional[Dict] = None) -> ModelsHYD:
    """Factory function to create models instance"""
    instance = ModelsHYD(config)
    instance.initialize()
    return instance
