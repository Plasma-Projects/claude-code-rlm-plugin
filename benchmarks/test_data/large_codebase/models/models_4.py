...
class ModelsYYC:
    """
    ModelsYYC class for handling models operations
    """
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"ModelsYYC initialized successfully")
            return True
        except Exception as e:
            logger.error(f"Failed to initialize ModelsYYC: {e}")
            return False
...
def create_models_instance(config: Optional[Dict] = None) -> ModelsYYC:
    """Factory function to create models instance"""
    instance = ModelsYYC(config)
    instance.initialize()
    return instance
